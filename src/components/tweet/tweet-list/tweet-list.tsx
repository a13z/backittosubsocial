...
import { Space } from '../tweet-item/Tweet';
import {
  InnerLoadMoreFn,
  loadMoreValuesArgs,
...
import { TweetV2UserTimelineResult } from 'node-twitter-api/types/v2/tweet.v2.types';
...
// const TweetList: FC<TweetV2UserTimelineResult> = ({ ids, withUnlisted = false }) => {
